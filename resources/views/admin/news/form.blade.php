...
@section('content')
    <style>
      div.layui-form-select{ display: none; }
    </style>
    <div style="padding: 15px;">
        ...
        <div class="layui-form-item" pane="">
             {!! Form::label('newsint', '选择发布', ['class' => 'layui-form-label']) !!}
            <div class="layui-input-block">
              @if(!isset($model))
                  <input type="checkbox" name="newsint[yzyx]" value="1" lay-skin="primary" title="集团官网" @if(session('siteid') == 1)  checked="" @endif>
                  <br>
                  <input type="checkbox" name="newsint[hfyzyx]" value="4" lay-skin="primary" title="合肥艺朝艺夕" @if(session('siteid') == 4)  checked="" @endif>
                  <input type="checkbox" name="newsint[hfpwe]" value="2" lay-skin="primary" title="合肥跑沃尔" @if(session('siteid') == 2) checked="" @endif>
                  <input type="checkbox" name="newsint[hffeyy]" value="3" lay-skin="primary" title="合肥弗恩英语" @if(session('siteid') == 3)  checked="" @endif>
                  <br>
                  <input type="checkbox" name="newsint[njyzyx]" value="5" lay-skin="primary" title="南京艺朝艺夕" @if(session('siteid') == 5)  checked="" @endif>
                  <input type="checkbox" name="newsint[njpwe]" value="10" lay-skin="primary" title="南京跑沃尔" @if(session('siteid') == 9)  checked="" @endif>
                  <input type="checkbox" name="newsint[njfeyy]" value="7" lay-skin="primary" title="南京弗恩英语" @if(session('siteid') == 7)  checked="" @endif>
                  <br>
                  <input type="checkbox" name="newsint[hzyzyx]" value="6" lay-skin="primary" title="杭州艺朝艺夕" @if(session('siteid') == 6)  checked="" @endif>
                  <input type="checkbox" name="newsint[hzpwe]" value="9" lay-skin="primary" title="杭州跑沃尔" @if(session('siteid') == 10)  checked="" @endif>
                  <input type="checkbox" name="newsint[hzfeyy]" value="8" lay-skin="primary" title="杭州弗恩英语" @if(session('siteid') == 8)  checked="" @endif>
              @else
                  <input type="checkbox" name="newsint[yzyx]" value="1" lay-skin="primary" title="集团官网" @if(in_array('1', $model->newsint)) checked @elseif(session('siteid') == 1) checked @endif>
                  <br>
                  <input type="checkbox" name="newsint[hfyzyx]" value="4" lay-skin="primary" title="合肥艺朝艺夕" @if(in_array('4', $model->newsint)) checked @elseif(session('siteid') == 4) checked="" @endif>
                  <input type="checkbox" name="newsint[hfpwe]" value="2" lay-skin="primary" title="合肥跑沃尔" @if(in_array('2', $model->newsint)) checked @elseif(session('siteid') == 2) checked="" @endif>
                  <input type="checkbox" name="newsint[hffeyy]" value="3" lay-skin="primary" title="合肥弗恩英语" @if(in_array('3', $model->newsint)) checked @elseif(session('siteid') == 3) checked="" @endif>
                  <br>
                  <input type="checkbox" name="newsint[njyzyx]" value="5" lay-skin="primary" title="南京艺朝艺夕" @if(in_array('5', $model->newsint)) checked @elseif(session('siteid') == 5) checked="" @endif>
                  <input type="checkbox" name="newsint[njpwe]" value="8" lay-skin="primary" title="南京跑沃尔" @if(in_array('9', $model->newsint)) checked @elseif(session('siteid') == 8) checked="" @endif>
                  <input type="checkbox" name="newsint[njfeyy]" value="7" lay-skin="primary" title="南京弗恩英语" @if(in_array('7', $model->newsint)) checked @elseif(session('siteid') == 7) checked="" @endif>
                  <br>
                  <input type="checkbox" name="newsint[hzyzyx]" value="6" lay-skin="primary" title="杭州艺朝艺夕" @if(in_array('6', $model->newsint)) checked @elseif(session('siteid') == 6) checked="" @endif>
                  <input type="checkbox" name="newsint[hzpwe]" value="9" lay-skin="primary" title="杭州跑沃尔" @if(in_array('10', $model->newsint)) checked @elseif(session('siteid') == 9) checked="" @endif>
                  <input type="checkbox" name="newsint[hzfeyy]" value="10" lay-skin="primary" title="杭州弗恩英语" @if(in_array('8', $model->newsint)) checked @elseif(session('siteid') == 10) checked="" @endif>
              @endif
            </div>
        </div>
        <div class="layui-form-item">
