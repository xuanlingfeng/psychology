            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        @elseif(session('siteid') == 2)
                        <a href="{{ url('/power/newslist/?id='.$article->id) }}" target="_blank" class="layui-btn layui-btn-small layui-btn-primary layuiBtn">查看</a>
                        @elseif(session('siteid') == 3)
                        <a href="{{ url('/fuenabc/newslist/?id='.$article->id) }}" target="_blank" class="layui-btn layui-btn-small layui-btn-primary layuiBtn">查看</a>
                        @elseif(session('siteid') == 4)
                        <a href="{{ url('/ahyzyx/xinwenxiangqing/?id='.$article->id) }}" target="_blank" class="layui-btn layui-btn-small layui-btn-primary layuiBtn">查看</a>
                        @elseif(session('siteid') == 5)
                        <a href="{{ url('/njyzyx/xinwenxiangqing/?id='.$article->id) }}" target="_blank" class="layui-btn layui-btn-small layui-btn-primary layuiBtn">查看</a>
                        @elseif(session('siteid') == 6)
                        <a href="{{ url('/hzyzyx/xinwenxiangqing/?id='.$article->id) }}" target="_blank" class="layui-btn layui-btn-small layui-btn-primary layuiBtn">查看</a>
                        @elseif(session('siteid') == 7)
                        <a href="{{ url('/njfuenabc/newslist/?id='.$article->id) }}" target="_blank" class="layui-btn layui-btn-small layui-btn-primary layuiBtn">查看</a>
                        @elseif(session('siteid') == 8)
                        <a href="{{ url('/hzfuenabc/newslist/?id='.$article->id) }}" target="_blank" class="layui-btn layui-btn-small layui-btn-primary layuiBtn">查看</a>
                        @endif
